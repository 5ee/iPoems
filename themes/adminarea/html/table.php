...
<?php }elseif ($this->vars[2]!="comments" && $this->vars[2]!="ratings" && $this->vars[2]!="saves" && $this->vars[2]!="like_dislike"  && $this->vars[2]!="submission")  {?>
...
?>
    <div class="alert alert-block alert-danger fade in">
      ...
      <?php if($this->vars[2]!="comments" && $this->vars[2]!="ratings" && $this->vars[2]!="saves" && $this->vars[2]!="like_dislike" && $this->vars[2]!="submission") {?>
...
?>
    <div class="well well-small pull-right" style="padding:6px;"> Per Page:
      <select class="show-per-page">
        ...
        <option value="all" <?php if($this->perpage == 'all'){ echo "selected='selected'"; }?>>all</option>
      </select>
      ...
      <thead>
        <tr >
          ...
          <?php 
			...
			?>
          <th><a href="javascript:void(0);" class="sortbyASC" fieldname="<?php echo $header; ?>" method="<?php if($this->current_order == "ASC"){echo "DESC";}else{echo "ASC";}?>"><?php echo format_names($header); ?>
