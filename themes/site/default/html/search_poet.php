    ...
    <div class="panel panel-default" style="margin-top: 30px;">
       ...
       <table class="table table-striped table-hover" style="margin-top: 0px;">
              <thead>
                  <tr style="background-color: #dddddd">
                      ...
                      <th><?php echo POET_NAME;?></th>
                      <th><?php echo RATING;?></th>
                  </tr>
              </thead>
              <tbody>
                   <?php $count=1;foreach($this->search_results as $poets) {//pr($page_poems);?> 
		 <tr>
                 <td><?php echo $count;$count++;?></td>
                 <td><a href="<?php echo get_url($this->database, "poet", $poets['id']."/".$poets['poem_slug'])?>"><?php echo text_limit($poets['Author_name'],35)?>...</a></td>
                 <td style="font-size:18px;text-align:left;margin-left:-10px">
                      <div class="rating"  data-toggle="tooltip" data-placement="bottom" title="<?php echo get_ratings_text("author", $poets['id'], $this->database) ?>"  style="font-size:16px; color: #e48a07;">
                     <?php  show_ratings_html("author",$poets['id'],$this->database,false,false);?>
                      </div>
                     </td>
         	 </tr>
                   <?php } ?>
       ...
       <div class="alert-message alert-message-danger" style="margin-right: 10px; margin-left: 10px;">
                    ...
                    <h4>
                       <?php echo WOOPS;?></h4>
                    <p class="txt font-16">
                        <?php echo NO_POET_OF_KEYWORD;?> <br /><br />
                    </p>
                </div>
           <?php }?>
